...
public:
    ...
    */
    ...
    static Vec3 getPosition() noexcept {
        return ActiveRenderInfo::position;
    }

    static float getRotationX() noexcept {
        return ActiveRenderInfo::rotationX;
    }

    static float getRotationXZ() noexcept {
        return ActiveRenderInfo::rotationXZ;
    }

    static float getRotationZ() noexcept {
        return ActiveRenderInfo::rotationZ;
    }

    static float getRotationYZ() noexcept {
        return ActiveRenderInfo::rotationYZ;
    }

    static float getRotationXY() noexcept {
